...
create_data['history'] = ['id', 'title', 'data', 'date', 'ip', 'unique_id', 'send', 'leng', 'hide', 'type']
...
if __name__ == "__main__":
    ...
    http_server = tornado.httpserver.HTTPServer(tornado.wsgi.WSGIContainer(app), ssl_option=ssl_ctx)
